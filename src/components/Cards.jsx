    ...
    <>
      <div className="w-full py-[10rem] px-4 bg-white ">
        <div className="max-w-[1240px] mx-auto grid md:grid-cols-3 gap-8">
          <div className="w-full shadow-xl flex flex-col  hover:scale-105 duration-300 p-4 my-8 rounded-lg">
            <img
          ...
          <div className="w-full shadow-xl flex flex-col md:my-0 bg-gray-100 hover:scale-105 duration-300 p-4 my-8 rounded-lg">
            <img
              className="w-20  mx-auto mt-[-3rem] bg-white"
              src={Double}
              alt="/"
